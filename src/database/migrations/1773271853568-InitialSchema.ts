...
export class InitialSchema1773271853568 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "mentor_connections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(120) NOT NULL, "mentor_id" character varying(120) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ce7b7ce433618e22342ea9fae27" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "needs_assessments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(120) NOT NULL, "needs" jsonb NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d181c4dd2166613a4f41d354c33" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sector_selections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(120) NOT NULL, "sectors" jsonb NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1537dc8cff87dc5385f6eabd5cb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "entrepreneurship_skills" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(120) NOT NULL, "skills" jsonb NOT NULL, "ratings" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7b32ccd994c8cd174fb2d0e6d64" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "entrepreneurship_barriers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(120) NOT NULL, "barriers" jsonb NOT NULL, "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d303a7c6c1f5c96f89e752ecf8e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "support_preferences" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(120) NOT NULL, "preferences" jsonb NOT NULL, "details" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a9b09b0b067ea2baf9236233342" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "communication_trainings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" character varying(120) NOT NULL, "skills" jsonb NOT NULL, "ratings" jsonb, "completedModules" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_71234c0a5de80c0aafd5e6df01f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "questionnaire_answers" ADD "interest_categories" jsonb`);
        await queryRunner.query(`ALTER TABLE "questionnaire_answers" ADD "soft_skills_answers" jsonb`);
        await queryRunner.query(`ALTER TABLE "opportunities" ADD "description" text`);
        await queryRunner.query(`ALTER TABLE "opportunities" ADD "required_skills" jsonb DEFAULT '[]'`);
        await queryRunner.query(`ALTER TABLE "opportunities" ADD "suitable_for_needs" jsonb DEFAULT '[]'`);
        await queryRunner.query(`ALTER TABLE "interview_sessions" ADD "answers" jsonb`);
        await queryRunner.query(`ALTER TABLE "interview_sessions" ADD "feedback" jsonb`);
        await queryRunner.query(`ALTER TABLE "interview_sessions" ADD "score" integer`);
        await queryRunner.query(`ALTER TABLE "interview_sessions" ADD "status" character varying(20) NOT NULL DEFAULT 'pending'`);
        await queryRunner.query(`ALTER TABLE "interview_sessions" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
